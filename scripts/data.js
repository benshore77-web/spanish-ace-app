export const TOPIC_DATA = [
  {
    ...
    description: "Learn to count and talk about ages.",
    words: [
  ...
  },
  {
    ...
    description: "Remember the months of the year.",
    words: [
  ...
  },
  {
    ...
    description: "Talk about pets and animals at home.",
    words: [
      { english: "a dog", spanish: "un perro" },
      { english: "a cat", spanish: "un gato" },
      { english: "a bird", spanish: "un pájaro" },
      { english: "a mouse", spanish: "un ratón" },
      { english: "a fish", spanish: "un pez" },
      { english: "a guinea pig", spanish: "una cobaya" },
      { english: "a snake", spanish: "una serpiente" }
    ]
  },
  {
    id: "pet-descriptions",
    title: "¿Cómo son?",
    description: "Describe what pets are like.",
    words: [
      { english: "ugly", spanish: "feo" },
      { english: "pretty", spanish: "bonito" },
      { english: "big", spanish: "grande" },
      { english: "small", spanish: "pequeño" },
      { english: "friendly", spanish: "simpático" },
      { english: "unfriendly", spanish: "antipático" },
  ...
  },
  {
    id: "colours",
    title: "Los colores",
    description: "Master the core colour palette.",
    words: [
  ...
  {
    id: "frequency",
    title: "Palabras muy frecuentes",
    description: "Useful words to boost every sentence.",
    words: [
